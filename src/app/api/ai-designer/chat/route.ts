...
const CATEGORY_STYLE_GUIDE: Record<string, string> = {
  ...
  "בר/בת מצווה":
    "חגיגי ומכובד, לא ילדותי: נייבי/שחור עם זהב מבריק, דפוסי גיאומטריה מודגשים, אפשר מגן דוד כמוטיב לבר מצווה, ניצוצות/קונפטי מוזהב.",
  "חינה":
